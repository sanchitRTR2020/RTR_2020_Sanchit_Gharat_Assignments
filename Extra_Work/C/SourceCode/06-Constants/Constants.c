...
#define MY_PI_SSG 3.1415926535897932

#define AMC_STRING_SSG "AstroMediComp RTR 3.0"
...
int main(void)
{
	...
	const double epsilon_SSG = 0.000001;
	...
	printf("Area Of Circle Of Radius 2 units = %f\n\n", (MY_PI_SSG * 2.0f * 2.0f)); //pi * r * r = area of circle of radius 'r'

    printf("\n\n");
    
    printf(AMC_STRING_SSG);
    printf("\n\n");
